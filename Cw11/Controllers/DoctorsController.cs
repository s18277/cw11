...
namespace Cw11.Controllers
{
    ...
    public class DoctorsController : ControllerBase
    {
        ...
        public IActionResult GetDoctor([FromRoute] int id)
        {
            ...
            if (doctor == null) return BadRequest("Doctor with requested ID doesn't exist!");
            return Ok(doctor);
        }
        ...
        public IActionResult AddDoctor([FromBody] NewDoctorRequest newDoctorRequest)
        {
            ...
            if (modifiedEntries == 0) return BadRequest("No entries were modified, probably wrong ID was requested.");
